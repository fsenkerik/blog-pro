...
.login-foot .pw{display:inline-flex;align-items:center;gap:8px}
...
.login-desc{font-size:14px;color:var(--body);margin-bottom:28px}
.login-form .form-group{margin-bottom:16px}
.login-submit{width:100%;padding:12px;font-size:14px;justify-content:center}
.login-error{background:var(--danger-soft);color:var(--danger);padding:10px 14px;border-radius:8px;margin-bottom:18px;font-size:13px;border:1px solid rgba(153,27,27,.12)}
.login-foot-note{margin-top:40px;font-size:12px;color:var(--muted);text-align:center}
...
<div class="login-shell">
  ...
  <div class="login-art">
    ...
    <div class="login-quote">
      ...
      <cite>&mdash; Manifesto redakčního nástroje · 2026</cite>
    </div>
    <div class="login-foot">
      <span class="pw"><span class="d"></span>Všechny systémy běží</span>
      <span>v1.0 · Blog Pro</span>
    </div>
  </div>

  <div class="login-form-wrap">
    <div class="login-card">
      <div class="login-eyebrow">Přihlášení · Interní</div>
      ...
      <div class="login-foot-note mono">&copy; 2026 Blog Pro</div>
    </div>
  </div>
</div>
</body>
